Feature: Gerenciamento de Apartamentos
  ...
  Scenario: Admin do condomínio cria apartamento retorna 201
    ...
    When eu crio um apartamento com numero "101" com 100 metros quadrados no bloco de teste
    Then o status da resposta é 201
    And a resposta tem o campo "$.data.numero" com valor "101"

  Scenario: Buscar apartamento por ID
    Given estou autenticado como admin do condomínio
    Given eu crio um apartamento com numero "201" com 100 metros quadrados no bloco de teste
  ...
  Scenario: Atualizar apartamento retorna 200
    Given estou autenticado como admin do condomínio
    Given eu crio um apartamento com numero "301" com 100 metros quadrados no bloco de teste
    When eu atualizo o último apartamento criado com numero "301-A" e metragem 100
    Then o status da resposta é 200
    And a resposta tem o campo "$.data.numero" com valor "301-A"

  Scenario: Deletar apartamento retorna 204
    Given estou autenticado como admin do condomínio
    Given eu crio um apartamento com numero "401" com 100 metros quadrados no bloco de teste
  ...
  Scenario: ROLE_USER não pode criar apartamento (403)
    ...
    When eu crio um apartamento com numero "501" com 100 metros quadrados no bloco de teste
