...
/**
 * Configures the Spring Authorization Server with OAuth2/OIDC support, RSA-signed JWTs, and a single registered client.
 */
@Configuration
...
public class AuthorizationServerConfig {
    ...
    /**
     * Registers the authorization server security filter chain with OIDC enabled and bearer-token error handling.
     *
    ...
    /**
     * Creates an in-memory {@link RegisteredClientRepository} configured with credentials and token settings from {@link JwtProperties}.
     *
    ...
    /**
     * Adds a {@code roles} claim to access tokens so they remain consistent with tokens issued by {@code AuthController}.
     *
