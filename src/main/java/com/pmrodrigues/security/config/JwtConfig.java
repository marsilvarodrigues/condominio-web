...
/**
 * Provides {@link JwtDecoder} and {@link JwtEncoder} beans, extending the default decoder with token-blacklist enforcement.
 */
@Configuration
...
public class JwtConfig {
    ...
    /**
     * Overrides the default {@link JwtDecoder} to reject tokens that have been revoked via {@link TokenBlacklistService}.
     *
