 ...
 *
 * <p>Condominio associations are managed by the service layer; mappers only read IDs for the DTO output.
 */
@Mapper(componentModel = "spring", nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
public interface UserMapper {

    /**
     * Converts a creation DTO to a new {@link User} entity, leaving security, audit, and condominio fields unset.
     *
    ...
    /**
     * Converts a full DTO to a new {@link User} entity, leaving security, audit, and condominio fields unset.
     *
     * @return a new {@link User} populated from {@code dto}
     */
    @Mapping(target = "password", ignore = true)
    ...
    /**
     * Converts a {@link User} entity to its DTO representation, mapping condominio entities to their IDs.
     *
