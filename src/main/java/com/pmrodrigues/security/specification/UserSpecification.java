...
public class UserSpecification {
  ...
  /**
   * Returns a specification that matches users whose name contains the given substring
  ...
  /**
   * Returns a specification that matches users whose email contains the given substring
   * (case-insensitive), or {@code null} when the filter is absent.
   */
  ...
  /**
   * Returns a specification that matches users by their enabled status, or {@code null} when the
   * filter is absent.
   */
  ...
  /**
   * Returns a specification that matches users who have the given role, or {@code null} when the
   * filter is absent.
   */
