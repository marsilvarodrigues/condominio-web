...
public abstract class PessoaMapper {
    ...
    /**
     * Converts a {@link Pessoa} entity to its full DTO representation.
     * The {@code tipo} field carries the SINGLE_TABLE discriminator value.
     *
    ...
    /**
     * Applies non-null DTO fields onto an existing entity.
     * {@code id}, {@code condominio}, soft-delete, and audit fields are never overwritten.
     *
    ...
    /**
     * Extracts the CPF from a {@link Morador} or {@link ProprietarioPessoaFisica}; returns
