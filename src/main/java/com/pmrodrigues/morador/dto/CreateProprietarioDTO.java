...
/**
 * Creation payload for a {@code Proprietario}.
 * The {@code tipo} discriminator selects the concrete sub-type ({@code PROP_PF} or {@code PROP_PJ}).
 * Cross-field constraints ensure CPF is present for natural persons and CNPJ for legal entities.
 *
