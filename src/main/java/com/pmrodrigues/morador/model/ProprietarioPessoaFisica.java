...
/**
 * Concrete JPA entity for a property owner who is a natural person (pessoa física). Stored as a
 * SINGLE_TABLE row in {@code pessoas} with discriminator value {@code PROP_PF}.
 */
@Getter
@Setter
@NoArgsConstructor
