...
/**
 * Factory class providing JPA {@link Specification} predicates for querying {@link Proprietario}
 * entities.
 */
...
public class ProprietarioSpecification {
  ...
  /**
   * Returns a specification matching proprietarios that own the given apartment, or {@code null}
   * when absent.
   *
