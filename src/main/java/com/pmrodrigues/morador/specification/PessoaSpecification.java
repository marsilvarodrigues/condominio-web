...
/**
 * Factory class providing JPA {@link Specification} predicates for querying {@link Pessoa} entities.
 */
...
public class PessoaSpecification {
    ...
    /**
     * Returns an exact-match specification on the {@code pessoa_tipo} discriminator column,
     * or {@code null} when absent. Valid values: MORADOR, PROP_PF, PROP_PJ.
     *
    ...
    /**
     * Returns an exact-match specification on the email field from the parent {@code users} table,
