 ...
 *
 * <p>Each method returns {@code null} when the filter value is absent — {@code null}
 * predicates are safely ignored by {@link Specification#allOf(Specification[])}.
 */
public final class CobrancaSpecification {
    ...
    public static Specification<Cobranca> hasApartamento(Long apartamentoId) {
        return (root, query, cb) -> apartamentoId == null ? null
                : cb.equal(root.get("apartamento").get("id"), apartamentoId);
    }
    ...
    public static Specification<Cobranca> vencimentoFrom(LocalDate from) {
        return (root, query, cb) -> from == null ? null
                : cb.greaterThanOrEqualTo(root.get("vencimento"), from);
    }
    ...
    public static Specification<Cobranca> vencimentoTo(LocalDate to) {
        return (root, query, cb) -> to == null ? null
                : cb.lessThanOrEqualTo(root.get("vencimento"), to);
    }
    ...
    public static Specification<Cobranca> emailEnviado(Boolean emailEnviado) {
        return (root, query, cb) -> emailEnviado == null ? null
                : cb.equal(root.get("emailEnviado"), emailEnviado);
    }
}
