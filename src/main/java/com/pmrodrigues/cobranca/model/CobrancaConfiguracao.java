 ...
 * com.pmrodrigues.cobranca.service.CobrancaService} falls back to the defaults
 * from {@link com.pmrodrigues.cobranca.config.CobrancaProperties}.
 *
 * <p>Not partitioned — the table has one row per condominium and is small enough
 * that partitioning would add no benefit. Tenant isolation is enforced by the
 * unique constraint on {@code condominio_id}.
 */
@Getter
@Setter
@NoArgsConstructor
