 ...
 *
 * <p>Template file: {@code templates/email/cobranca.vm}
 * The record component names match the {@code $variableName} placeholders in the template exactly.
 * Monetary and date formatting is encapsulated in {@link #model()} so the template itself
 * remains logic-free.
 *
