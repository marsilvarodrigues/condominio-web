...
/**
 * Factory class providing JPA {@link Specification} predicates for querying {@link Condominio}
 * entities.
 */
...
public class CondominioSpecification {
  ...
  /**
   * Returns a specification that matches condominios whose nome contains the given substring
  ...
  /**
   * Returns a specification that matches a condominio with the exact CNPJ, or {@code null} when the
   * filter is absent.
   *
