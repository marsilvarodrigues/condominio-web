...
/**
 * Factory class providing JPA {@link Specification} predicates for querying {@link Apartamento}
 * entities.
 */
...
public class ApartamentoSpecification {
  ...
  /**
   * Returns a specification that matches apartamentos belonging to the given bloco, or {@code null}
  ...
  /**
   * Returns a specification that matches apartamentos whose numero contains the given substring
