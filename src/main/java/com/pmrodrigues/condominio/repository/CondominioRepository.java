...
/**
 * Spring Data JPA repository for {@link Condominio} entities, supporting specification-based
 * filtering.
 */
@Repository
public interface CondominioRepository
    extends JpaRepository<Condominio, Long>, JpaSpecificationExecutor<Condominio> {
  ...
  /**
   * Returns the IDs of all non-deleted condominios. Used by the rateio scheduler to iterate over
   * every active tenant.
   */
