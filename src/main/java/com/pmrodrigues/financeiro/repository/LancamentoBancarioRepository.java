...
public interface LancamentoBancarioRepository
     ...
     */
    List<LancamentoBancario> findByContaBancariaIdAndStatus(Long contaBancariaId, StatusLancamento status);

    /**
     * Soft-deletes all lancamentos whose conta bancaria belongs to the given condominio.
     */
    @Modifying
    @Query(value = "UPDATE lancamentos_bancarios SET deleted = true " +
