 ...
 *
 * <p>The {@code confirmar} flag must be {@code true}; its presence as an explicit field prevents
 * accidental triggers and serves as an acknowledgement that all previously calculated quotas will
 * be replaced.
 */
