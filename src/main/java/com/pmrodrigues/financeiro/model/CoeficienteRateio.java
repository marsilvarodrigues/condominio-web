...
/**
 * Stores the weight (coefficient, area, or consumption) of a single unit within a {@link
 * GrupoDespesa}.
 *
 * <p>A new record is created whenever the value changes (historical versioning via {@code
 * vigencia}). Queries should use the record with the latest {@code vigencia} that is not after the
 * expense date.
 */
@Getter
@Setter
...
public class CoeficienteRateio implements TenantScoped {
