 ...
 *
 * <p>The {@link StatusRateio} lifecycle: a newly created expense starts as {@code PENDENTE}.
 * The daily scheduler (or a manual trigger) calculates the quotas and transitions the status
 * to {@code RATEADA} on success, or {@code ERRO} on failure.
 */
@Getter
@Setter
@NoArgsConstructor
