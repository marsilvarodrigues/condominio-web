 ...
 *
 * <p>Uses {@link CoeficienteRateio#getAreaM2()} as the weight. Throws {@link
 * IllegalArgumentException} if any unit has a null {@code areaM2}. The rounding remainder goes to
 * the unit with the largest area.
 */
@Component("METRAGEM")
