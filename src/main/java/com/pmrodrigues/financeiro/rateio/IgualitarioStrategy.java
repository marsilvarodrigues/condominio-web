 ...
 *
 * <p>Formula: {@code cota = despesaTotal / n}. The rounding remainder (at most R$0.01) is assigned
 * to the first unit in the list (index 0) as a deterministic tiebreaker.
 */
