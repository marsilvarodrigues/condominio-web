 ...
 *
 * <p>Uses {@link CoeficienteRateio#getCoeficiente()} as the weight. The sum of coefficients
 * is never assumed to equal 1.0, since convention documents can carry rounding imprecision.
 * The rounding remainder is assigned to the unit with the largest coefficient.
 */
