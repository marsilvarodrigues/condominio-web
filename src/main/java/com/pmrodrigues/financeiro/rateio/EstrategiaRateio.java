 ...
 *
 * <p>Contract: {@code Σ(returned values) == despesaTotal} with tolerance ±R$0.01
 * due to rounding. The rounding remainder is assigned to the unit with the largest
 * weight, ensuring a deterministic and exact result.
 *
...
public interface EstrategiaRateio {
     ...
     * @throws IllegalArgumentException if coeficientes is empty, despesaTotal is not positive,
     *                                  or required parametros entries are missing/invalid
     */
