...
public class DespesaService {
   ...
   * @throws org.springframework.web.server.ResponseStatusException 404 if the referenced group does
   *     not exist
   */
  @Transactional
  ...
  public DespesaDTO create(CreateDespesaDTO dto) {
    log.info(
        "Creating despesa: grupoDespesaId={}, competencia={}",
        dto.grupoDespesaId(),
        dto.competencia());
    var grupo =
        grupoDespesaService
            .findEntityById(dto.grupoDespesaId())
