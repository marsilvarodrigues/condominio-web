...
/**
 * Factory class providing JPA {@link Specification} predicates for querying {@link ContaBancaria}
 * entities.
 */
...
public class ContaBancariaSpecification {
  ...
  public static Specification<ContaBancaria> hasAgencia(String agencia) {
    ...
    return (root, query, cb) -> cb.like(root.get("agencia"), agencia + "%");
  }
  ...
  public static Specification<ContaBancaria> hasConta(String conta) {
    ...
    return (root, query, cb) -> cb.like(root.get("conta"), conta + "%");
  }
}
