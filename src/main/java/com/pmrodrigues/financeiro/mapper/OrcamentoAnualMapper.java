 ...
 *
 * <p>Abstract class required because {@code planoContasFromId} uses {@code
 * EntityManager.getReference()} to obtain a JPA proxy, which cannot be injected via the standard
 * MapStruct {@code uses} mechanism.
 */
@Mapper(
