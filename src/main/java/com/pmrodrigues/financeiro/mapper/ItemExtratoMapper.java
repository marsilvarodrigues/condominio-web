 ...
 *
 * <p>The nested {@link ItemOrcamento} association is mapped via {@link #toResumoResponse}, which
 * MapStruct selects automatically when encountering the matching source/target types.
 */
@Mapper(
...
public interface ItemExtratoMapper {
  ...
  /**
   * Converts a {@link ItemExtrato} entity to its full response representation, including the
   * optional budget line item association.
   *
  ...
  /**
   * Converts a {@link ItemOrcamento} to a compact summary response, flattening the {@link
   * com.pmrodrigues.financeiro.model.PlanoContas} reference.
   *
