...
public class LancamentoBancarioController {
     ...
     */
    @GetMapping
    @Timed(value = "lancamento.bancario.controller.findAll", description = "Find all lancamentos bancarios")
     ...
     */
    @GetMapping("/{id}")
    @Timed(value = "lancamento.bancario.controller.findById", description = "Find lancamento bancario by id")
     ...
     */
    @PostMapping
    @Timed(value = "lancamento.bancario.controller.create", description = "Create lancamento bancario")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<LancamentoBancarioDTO>> create(
            @Valid @RequestBody CreateLancamentoBancarioDTO dto,
            HttpServletRequest request) {
     ...
     */
    @PutMapping("/{id}")
    @Timed(value = "lancamento.bancario.controller.update", description = "Update lancamento bancario")
    @PreAuthorize("hasRole('ADMIN')")
     ...
     */
    @DeleteMapping("/{id}")
    @Timed(value = "lancamento.bancario.controller.delete", description = "Delete lancamento bancario")
    @PreAuthorize("hasRole('ADMIN')")
