...
/**
 * REST controller exposing CRUD endpoints for {@link com.pmrodrigues.financeiro.model.GrupoDespesa}.
 */
@Slf4j
@ApiVersion("1")
@RestController
...
public class GrupoDespesaController {
    ...
    public ResponseEntity<ApiResponse<List<GrupoDespesaDTO>>> findAll(
            @ModelAttribute GrupoDespesaFilterDTO filter,
    ...
    public ResponseEntity<ApiResponse<GrupoDespesaDTO>> create(
            @Valid @RequestBody CreateGrupoDespesaDTO dto,
            HttpServletRequest request) {
    ...
    public ResponseEntity<ApiResponse<GrupoDespesaDTO>> update(
            ...
            @Valid @RequestBody GrupoDespesaDTO dto,
            HttpServletRequest request) {
