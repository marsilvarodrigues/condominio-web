...
/**
 * Standard API envelope returned by all endpoints, carrying a correlation ID, payload, and server
 * timestamp.
 *
 * @param <T> type of the response payload
 */
public record ApiResponse<T>(
    @JsonProperty("request_id") @Nullable UUID requestId, T data, Instant timestamp) {
  /**
