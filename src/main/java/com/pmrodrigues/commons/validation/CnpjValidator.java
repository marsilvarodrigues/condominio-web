 ...
 * Accepts both formatted ({@code XX.XXX.XXX/XXXX-XX}) and unformatted 14-digit strings.
 * {@code null} and blank values are skipped (delegate to {@code @NotBlank}/{@code @NotNull}).
 */
