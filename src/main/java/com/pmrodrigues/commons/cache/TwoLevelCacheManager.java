...
/**
 * {@link CacheManager} that creates {@link TwoLevelCache} instances backed by a local Caffeine L1
 * and a Redis-backed L2 manager.
 */
...
public class TwoLevelCacheManager implements CacheManager {
  ...
  public Cache getCache(String name) {
    return caches.computeIfAbsent(
        name, n -> new TwoLevelCache(n, buildL1(n), l2Manager.getCache(n)));
  }
