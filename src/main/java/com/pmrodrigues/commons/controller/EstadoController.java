...
public class EstadoController {
  ...
  /**
   * Returns a list of estados, optionally filtered by nome (partial, case-insensitive) or uf
  ...
  public ResponseEntity<ApiResponse<List<EstadoDTO>>> findAll(
      @ModelAttribute EstadoFilterDTO filter, HttpServletRequest request) {
  ...
  public ResponseEntity<ApiResponse<EstadoDTO>> findById(
