...
/**
 * REST controller exposing CRUD endpoints for {@link com.pmrodrigues.commons.model.Banco}. Read
 * operations are public; write operations require the ADMIN role.
 */
@Slf4j
@ApiVersion("1")
@RestController
