...
/**
 * Utility methods for extracting values set by interceptors from the current {@link HttpServletRequest}.
 */
public final class RequestContextHelper {
    ...
    /**
     * Extracts the correlation UUID stored by {@code RequestIdInterceptor}, or {@code null} if absent.
     *
