...
public final class TenantContext {
    ...
    /**
     * Returns the active condominio ID bound to the current thread, or {@code null} if none is set (global access).
     *
    ...
    /**
     * Binds the list of condominio IDs the current user is allowed to access.
     * An empty list means global access to all condominios.
     *
    ...
    /**
     * Returns the list of condominio IDs the current user may access.
     * Returns an empty list if no restrictions are set (global access).
     *
