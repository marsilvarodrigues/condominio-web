 ...
 *
 * <p>Asaas sends a POST to the configured webhook URL whenever a payment event occurs.
 * This record captures the fields the application needs to process payment confirmations.
 *
