 ...
 *
 * <p>The output is a Base64-encoded PNG suitable for embedding in HTML email bodies as
 * {@code &lt;img src="data:image/png;base64,..."&gt;}.
 */
@Slf4j
@Component
    ...
    public String gerarBase64(String pixPayload) {
        ...
        try {
            ...
            BitMatrix matrix = new QRCodeWriter()
                    .encode(pixPayload, BarcodeFormat.QR_CODE, QR_SIZE, QR_SIZE, hints);

            var out = new ByteArrayOutputStream();
            MatrixToImageWriter.writeToStream(matrix, "PNG", out);
            String base64 = Base64.getEncoder().encodeToString(out.toByteArray());
            log.debug("Pix QR Code generated: {}x{} pixels, {} Base64 chars", QR_SIZE, QR_SIZE, base64.length());
            return base64;
        } catch (Exception e) {
